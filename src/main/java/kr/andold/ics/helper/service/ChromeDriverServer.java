...
@Slf4j
@Service
public class ChromeDriverServer {
	...
	public void postConstruct() {
		...
		chromeOptions.addArguments(String.format("--user-data-dir=%s-server", getUserDataDir()));
		chromeOptions.setPageLoadStrategy(PageLoadStrategy.NONE);
		driver = new ChromeDriverWrapper(chromeOptions);
		java.awt.Dimension d = MainFrame.sizeByScreen(5, 9);
		driver.manage().window().setSize(new Dimension(d.width, d.height));
		java.awt.Point p = MainFrame.locationByScreen(0, 2);
